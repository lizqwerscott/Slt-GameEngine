...
void Scene::SetRange(sf::FloatRect range) { this->m_loadRange = range; }

sf::FloatRect Scene::GetRange() { return this->m_loadRange; }
...
void Scene::DeletePhysicalWorld() { this->m_physicalWorld->release(); }
...
void Scene::popUpdateCallBack() { this->m_UpdateCallBacks.pop_back(); }

void Scene::popDrawCallBack() { this->m_DrawCallBacks.pop_back(); }
