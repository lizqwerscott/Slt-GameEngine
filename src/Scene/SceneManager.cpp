...
Scene *
SceneManager::GetRunScene()
{
	return SceneManager::GetSceneBack();
}

void SceneManager::SetRunScene(Scene * scene)
{
	SceneManager::push_(scene);
}
...
Scene * 
SceneManager::GetSceneBack()
{
	return sceneManager->m_Scenes.back();
}
